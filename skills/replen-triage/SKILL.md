...
4. Hold a 2-3 sentence verdict per match in your head — you'll use it in the HTML.
...
4. The briefing **must** include:
   - Verdict banner (KEEP / SKIP / BAD) at the top with 1-2 sentence reasoning.
...
- Verdicts are 2-3 sentences. If you need more, write a briefing.
...
- Don't fabricate signals you didn't measure. If you didn't compute star-velocity, don't put a number in the signal card — drop the card or mark it "—".
